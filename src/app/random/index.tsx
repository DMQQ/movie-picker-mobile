...
export default function RandomMovie() {
  ...
  const { movie, details, isLoading, isRevealed, fetchRandomMovie, revealMovie, resetCard, handleSuperLike, handleBlock, superLikeIconScale } =
    useRandomMovie({
      diceRotate,
      onReveal: () => {
        ...
        <View style={styles.content}>
          <Animated.View style={[styles.cardContainer, shakeCardStyle]}>
            ...
            <Animated.View style={[styles.cardFace, styles.backFace, backAnimatedStyle]}>
              {movie && <MovieResultCard movie={movie} details={details} />}
            </Animated.View>
          </Animated.View>
        </View>
