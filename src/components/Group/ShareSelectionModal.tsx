...
import { useShareSelection, MAX_SELECTION, ShareMovie } from "../../hooks/useShareSelection";
...
export default function ShareSelectionModal({ visible, onClose, movies }: ShareSelectionModalProps) {
      ...
      <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose} statusBarTranslucent>
        <View style={styles.overlay}>
          ...
          <View style={styles.ticketContent}>
            <IconButton icon="close" size={24} onPress={onClose} style={styles.ticketCloseButton} iconColor="#000" />
            <ViewShot ref={viewShotRef} options={{ format: "png", quality: 1, fileName: "collection-share.png" }} style={styles.viewShot}>
      ...
      <View style={styles.overlay}>
        ...
        <PlatformBlurView style={styles.content}>
          <View style={styles.inner}>
            <IconButton icon="close" size={24} onPress={onClose} style={styles.closeButton} iconColor="#fff" />
            {isLoading || isSharing ? (
...
const styles = StyleSheet.create({
  ...
  ticketCloseButton: { position: "absolute", top: 25, right: 25, zIndex: 10, backgroundColor: "rgba(255,255,255,0.1)" },
  ...
  content: {
    ...
    borderRadius: 35,
    overflow: "hidden",
    ...Platform.select({ android: { backgroundColor: "#000", borderWidth: 1, borderColor: "rgba(255,255,255,0.18)" } }),
  },
  inner: { padding: 30, alignItems: "center" },
  closeButton: { position: "absolute", top: 0, right: 0, zIndex: 10 },
  title: { fontSize: 32, fontFamily: "Bebas", color: "#fff", textAlign: "center", marginBottom: 8, letterSpacing: 1.2 },
  subtitle: { fontSize: 14, color: "rgba(255,255,255,0.75)", textAlign: "center", marginBottom: 20 },
